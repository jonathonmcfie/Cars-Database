...
def cont():
    ...
    while cont != "Y" or cont != "N":
        ...
        if cont == "Y":
            ...
            print("Thank you for using Jonathon's music database. Goodbye.\n")
            exit()
        else:
            print("That is not a valid decision, please try again\n")
def print_view(view_name:str):
...
def select_view():
    ...
    while choice != "Z":
        choice = input( "\nType the letter for the info you want.\n"
                        "A: Album Info.\n"
                        "B: Basic Info\n"
                        "C: First 5 songs from each album\n"
                        "D: Songs over 5 minutes\n"
                        "E: Songs from over 5 years ago (Not Musical)\n"
                        "F: Songs ordered by name\n"
                        "G: Medium length songs less than 5 years old\n"
                        "Z: Back\n\n"
                        "Enter your choice here: ")
        choice = choice.upper()
        if choice == "A":
            print("You chose A: Album Info.\n")
            print_view("album_info")
        elif choice == "B":
            print("You chose B: Basic Info\n")
            print_view("basic_info")
        elif choice == "C":
            print("You chose C: First 5 songs from each album\n")
            print_view("first_5_from_each_album")
        elif choice == "D":
            print("You chose D: Songs over 5 minutes\n")
            print_view("long_songs")
        elif choice == "E":
            print("You chose E: Songs from over 5 years ago (Not Musical)\n")
            print_view("old_not_musical")
        elif choice == "F":
            print("You chose F: Songs ordered by name\n")
            print_view("ordered_by_name")
        elif choice == "G":
            print("You chose G: Medium length songs less than 5 years old\n")
            print_view("recent_med_length_songs")
        elif choice == "Z":
...
print("\n\n\n\nWelcome to Jonathon's music database.\n")
choice = ""
while choice != "Z":
